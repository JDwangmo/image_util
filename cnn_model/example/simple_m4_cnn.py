...
class ImageCNN(object):
    ...
    def get_model(
        ...
        image_net = ImageNet(
            ...
            l1_conv_filter_type=[
                ...
                [num_filter1, filter1, filter1, 'valid', (2, 2), 0., 'relu', 'none','none',(2,2)],
            ...
            l2_conv_filter_type=[
                [num_filter2, filter2, filter2, 'valid', (2, 2), 0., 'relu', 'none','none',(2,2)],

            ],
            l3_conv_filter_type=[
                [num_filter3, filter3, filter3, 'valid', (2, 2), 0., 'relu', 'none','none',(2,2)],
    ...
    def cross_validation(
        ...
        for num_filter1 in num_filter1_list:
            for num_filter2 in num_filter2_list:
                for num_filter3 in num_filter3_list:
                    for hidden1 in hidden1_list:
                        for filter1 in filter1_list:
                            for filter2 in filter2_list:
                                for filter3 in filter3_list:
                                    print('=' * 40)
                                    print('num_filter1,num_filter2,num_filter2, hidden1,filter1,filter2,filter3 is %d,%d,%d,%d,%d,%d,%d.'%(num_filter1,num_filter2,num_filter3,
                                                                                                                               hidden1,
                                                                                                                               filter1,
                                                                                                                               filter2,
                                                                                                                               filter3,
